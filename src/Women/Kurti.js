...
function WomenKurti() {
    ...
    useEffect(() => {
        async function fetchData() {
            try {
                const res = await fetch(`https://academics.newtonschool.co/api/v1/ecommerce/clothes/products?filter={"subCategory":"kurti"}`, {
                    method: 'GET',
                    headers: {
    ...
    return (
        <div className='mens-wear'>
            <section className='productcontainer'>
                <h3 className='headingg'>Women's Kurti</h3>
